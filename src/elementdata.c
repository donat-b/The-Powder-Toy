...
part_type ptypes[PT_NUM] =
{
	...
	{"PSTN",	PIXPACK(0xAA9999),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	0,	0,	1,	1,	100,	SC_FORCE,		R_TEMP+0.0f +273.15f,	0,		"Piston, extends and pushes particles", ST_SOLID, TYPE_SOLID|PROP_LIFE_DEC, &update_PSTN, &graphics_PSTN},
	{"FRME",	PIXPACK(0x999988),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	0,	0,	1,	1,	100,	SC_SOLIDS,		R_TEMP+0.0f +273.15f,	0,		"Frame, can be used with pistons to push many particles", ST_SOLID, TYPE_SOLID|PROP_LIFE_DEC, NULL, &graphics_PSTN},
