...
part_type ptypes[PT_NUM] =
{
	...
	{"VIBR",	PIXPACK(0x005000),	0.0f,	0.00f * CFDS,	0.85f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	0,	0,	1,	1,	100,	SC_NUCLEAR,		273.15f,				251,	"Vibranium. Stores energy and releases it in violent explosions.", ST_SOLID, TYPE_SOLID|PROP_LIFE_DEC, &update_VIBR, &graphics_VIBR},
	{"BVBR",	PIXPACK(0x005000),	0.3f,	0.02f * CFDS,	0.95f,	0.80f,	0.0f,	0.15f,	0.00f,	0.000f	* CFDS,	1,	0,		0,	0,	0,	1,	1,	67,		SC_POWDERS,		273.15f,				164,	"Broken vibranium.", ST_SOLID, TYPE_PART|PROP_LIFE_DEC, &update_VIBR, &graphics_VIBR},
	//Name		Colour				Advec	Airdrag			Airloss	Loss	Collid	Grav	Diffus	Hotair			Fal	Burn	Exp	Mel	Hrd M	Use	Weight	Section			H						Ins		Description
};
