...
part_type ptypes[PT_NUM] =
{
	...
	{"CRAY",	PIXPACK(0xBBFF00),	0.0f,	0.00f * CFDS,	0.90f,	0.00f,	0.0f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	0,	1,	1,	1,	100,	SC_ELEC,		R_TEMP+0.0f +273.15f,	0,		"Particle Ray Emitter. Creates a beam of particles set by ctype, range is set by tmp2", ST_SOLID, TYPE_SOLID|PROP_LIFE_DEC, &update_CRAY, NULL},
