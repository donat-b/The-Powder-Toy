...
int run_stickman(playerst* playerp, UPDATE_FUNC_ARGS)
{
	...
	if (((int)(playerp->comm)&0x01) == 0x01)
	{
		...
		if (dl>dr)
		{
			if (INBOND(playerp->legs[4], playerp->legs[5]) && !eval_move(t, (int)playerp->legs[4], (int)playerp->legs[5]))
			{
		...
		{
			if (INBOND(playerp->legs[12], playerp->legs[13]) && !eval_move(t, (int)playerp->legs[12], (int)playerp->legs[13]))
			{
	...
	if (((int)(playerp->comm)&0x04) == 0x04)
	{
		...
		else if ((INBOND(playerp->legs[4], playerp->legs[5]) && !eval_move(t, (int)playerp->legs[4], (int)playerp->legs[5])) ||
				 (INBOND(playerp->legs[12], playerp->legs[13]) && !eval_move(t, (int)playerp->legs[12], (int)playerp->legs[13])))
		{
			parts[i].vx -= 4*gvx;
			parts[i].vy -= 4*gvy;
			playerp->accs[2] -= gvx;
