...
DEFINE_ELEMENT(VIRS, PT_NORMAL_NUM+6)
DEFINE_ELEMENT(VRSS, PT_NORMAL_NUM+7)
DEFINE_ELEMENT(VRSG, PT_NORMAL_NUM+8)
DEFINE_ELEMENT(CURE, PT_NORMAL_NUM+9)
DEFINE_ELEMENT(BUTN, PT_NORMAL_NUM+10)
DEFINE_ELEMENT(PINV, PT_NORMAL_NUM+11)
DEFINE_ELEMENT(RAZR, PT_NORMAL_NUM+12)
DEFINE_ELEMENT(COND, PT_NORMAL_NUM+13)
DEFINE_ELEMENT(PWHT, PT_NORMAL_NUM+14)
DEFINE_ELEMENT(EXPL, PT_NORMAL_NUM+15)
