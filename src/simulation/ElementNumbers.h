...
DEFINE_ELEMENT(DKLQ, PT_FAKE_NUM)
DEFINE_ELEMENT(STKW, PT_FAKE_NUM+1)
DEFINE_ELEMENT(DIRT, PT_FAKE_NUM+2)
DEFINE_ELEMENT(MUD, PT_FAKE_NUM+3)
DEFINE_ELEMENT(COCO, PT_FAKE_NUM+4)
DEFINE_ELEMENT(COCJ, PT_FAKE_NUM+5)
DEFINE_ELEMENT(OBMA, PT_FAKE_NUM+6)
DEFINE_ELEMENT(BLOD, PT_FAKE_NUM+7)
DEFINE_ELEMENT(POOP, PT_FAKE_NUM+8)
DEFINE_ELEMENT(LOLZ2, PT_FAKE_NUM+9)
DEFINE_ELEMENT(CMD, PT_FAKE_NUM+10)
DEFINE_ELEMENT(DMD2, PT_FAKE_NUM+11)
DEFINE_ELEMENT(BDMD, PT_FAKE_NUM+12)
DEFINE_ELEMENT(BATT, PT_FAKE_NUM+13)
DEFINE_ELEMENT(DIMT, PT_FAKE_NUM+14)
