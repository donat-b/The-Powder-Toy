...
#define RENDER_GLOW		OPTIONS | PSPEC_STICKMAN | PMODE_FLAT | PMODE_ADD | PMODE_BLEND | PMODE_GLOW | PMODE_SPARK | PMODE_FLARE | PMODE_LFLARE
#define RENDER_BLUR		OPTIONS | PSPEC_STICKMAN | PMODE_FLAT | PMODE_ADD | PMODE_BLEND | PMODE_BLUR
