...
#define MOD_SAVE_VERSION 18 //This is not the version number of my mod anymore, it's only changed when I change the saving code
#define MOD_BUILD_VERSION 36 //For update checks
